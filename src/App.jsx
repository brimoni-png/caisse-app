...
const G = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  body{background:${C.bg};-webkit-font-smoothing:antialiased;font-family:'DM Sans',sans-serif;}
...
const T = {
  fr: {
    ...
    greeting: "السلام عليكم !", userName: "Cheikh Sidi", subtitle: "Caisse communautaire",
  ...
  ar: {
    ...
    greeting: "السلام عليكم !", userName: "الشيخ سيدي", subtitle: "صندوق تعاوني",
