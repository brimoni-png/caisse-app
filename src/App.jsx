...
// ─── REPORTS ──────────────────────────────────────────────────────────────────
function Reports({ txs, members, lang, chartReady, onRefresh, onReset }) {
  const t = T[lang];
  ...
  return (
    <div style={{ background: C.bg, minHeight: "100vh", minHeight: "100dvh", width: "100%", maxWidth: 430, margin: "0 auto", fontFamily: "'Manrope','Segoe UI',sans-serif", color: C.text, position: "relative", paddingBottom: 90, overflowX: "hidden" }}>
      ...
      <div style={{ padding: "20px 16px" }}>
        ...
        {tab === "reports"  && <Reports key="reports-tab" txs={txs} members={members} lang={lang} chartReady={chartReady} onRefresh={fetchAll} onReset={resetAll} />}
